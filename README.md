![Logo](https://res.cloudinary.com/dylbp6bql/image/upload/v1719842041/readme%20file/tper85wi5ygfpxjsd5s7.png)
...
<details>
  <summary><strong>Privacy and Account Management 🔒</strong></summary> &nbsp;
  <ul>
    <li>Secure login/logout functionality</li>
    <li>Option to change profile picture and username</li>
  </ul>
</details>

<details>
  <summary><strong>Media Handling 📸</strong></summary>&nbsp;
  <ul>
    <li>View last 3 photos from device</li>
    <li>Select photos from gallery</li>
    <li>Take new photos in real-time</li>
    <li>Support for up to 2 images per checkpoint</li>
  </ul>
</details>

<details>
  <summary><strong>Real-time Updates ⏱️</strong></summary>&nbsp;
  <ul>
    <li>Like/unlike and follow/unfollow actions update in real-time</li>
    <li>Immediate visibility of new checkpoints and updates</li>
  </ul>
</details>
